...
class WheelTime(
    ...
    private fun setLunar(year: Int, month: Int, day: Int, isLeap: Boolean, h: Int, m: Int, s: Int) {
        ...
        wv_month!!.setAdapter(ArrayWheelAdapter<Any?>(ChinaDate.getMonths(year)))
        wv_month!!.setLabel("")
        ...
        wv_year!!.setOnItemSelectedListener(object : OnItemSelectedListener {
            override fun onItemSelected(index: Int) {
                ...
                // 判断是不是闰年,来确定月和日的选择
                wv_month!!.setAdapter(ArrayWheelAdapter<Any?>(ChinaDate.getMonths(year_num)))
