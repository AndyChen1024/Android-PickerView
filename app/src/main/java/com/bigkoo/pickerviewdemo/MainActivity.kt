...
import com.bigkoo.pickerviewdemo.JsonDataActivity
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    private val options1Items = arrayListOf<ProvinceBean?>()
    private val options2Items = arrayListOf<ArrayList<String?>?>()
    ...
    private val food = arrayListOf<String?>()
    private val clothes = arrayListOf<String?>()
    private val computer = arrayListOf<String?>()
    ...
    private fun initTimePicker() { //Dialog 模式下，在底部弹出
        pvTime = TimePickerBuilder(this, object : OnTimeSelectListener {
            ...
            .addOnCancelClickListener(View.OnClickListener {
                Log.i(
                    "pvTime",
        ...
        if (mDialog != null) {
            ...
            pvTime!!.contentContainer!!.layoutParams = params
